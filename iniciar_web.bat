@echo off
title Asistente Robin - Servidor Web
cd /d "%~dp0"
...
echo.
echo Servidor web. Abre en tu celular:  http://<IP-de-esta-PC>:8000
echo (misma red WiFi; la IP la ves con: ipconfig)
echo.
%PYTHON% "%~dp0servidor_web.py"
pause
